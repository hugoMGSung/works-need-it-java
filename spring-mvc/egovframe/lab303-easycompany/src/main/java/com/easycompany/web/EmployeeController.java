...
public class EmployeeController {
	...
	@ModelAttribute(name = "deptInfoOneDepthCategory")
	 ...
	 */
	/*
	 * @ModelAttribute("deptInfoTwoDepthCategory") private Map<String, String>
	 * referenceDataTwoDepthDept(@ModelAttribute("employee") Employee employee) {
	 * return departmentService.getDepartmentIdNameList("2",
	 * employee.getSuperdeptid()); }
	 */
